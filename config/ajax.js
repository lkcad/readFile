...
module.exports = {
    ...
    returnVal: {
        ...
        normalize: [
            {path: ['data', 'push_plans'], schema: 'Schemas.PC_MESSAGE_LIST'},
            {path: ['data', 'push_plans','asdsadsa'], schema: 'Schemas.PC_MESSAGE_LIST2'},
            {path: ['data', 'total'], name: 'total'}
        ]
    },
